...
foreach($name in @("README.md","SPEC-0.14-BETA.md","ARCHITECTURE-0.14.md","ACCEPTANCE-0.14-BETA.md","VALIDATION-0.14-BETA.md","RELEASE-0.14-BETA.md","ROADMAP.md")){Copy-Item (Join-Path $workspace $name) $final}
