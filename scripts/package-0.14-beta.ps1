...
$final=Join-Path $artifacts "Lumina-0.14.0-beta.1-portable-windows-x64"
$zip="$final.zip"
...
foreach($name in @("README.md","SPEC-0.14-BETA.md","ARCHITECTURE-0.14.md","RELEASE-0.14-BETA.md","ROADMAP.md")){Copy-Item (Join-Path $workspace $name) $final}
