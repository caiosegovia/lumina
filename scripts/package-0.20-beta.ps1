...
$release=Join-Path $workspace "src-tauri\target-0.20-beta\release"
$artifacts=Join-Path $workspace "artifacts"
$final=Join-Path $artifacts "Lumina-0.20.0-beta.1-portable-windows-x64"
$zip="$final.zip"
...
foreach($name in @("README.md","SPEC-0.20-BETA.md","ARCHITECTURE-0.20.md","RELEASE-0.20-BETA.md","VALIDATION-0.20-BETA.md","ROADMAP.md")){Copy-Item (Join-Path $workspace $name) $final}
