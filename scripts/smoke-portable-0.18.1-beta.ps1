...
$zip = (Resolve-Path (Join-Path $workspace "artifacts\Lumina-0.18.1-beta.1-portable-windows-x64.zip")).Path
$extract = Join-Path $env:TEMP ("Lumina-0181b1-Smoke-" + [guid]::NewGuid().ToString("N"))
