...
$zip = (Resolve-Path (Join-Path $workspace "artifacts\Lumina-0.20.0-beta.1-portable-windows-x64.zip")).Path
$extract = Join-Path $env:TEMP ("Lumina-020b1-Smoke-" + [guid]::NewGuid().ToString("N"))
