...
$zip = (Resolve-Path (Join-Path $workspace "artifacts\Lumina-0.14.0-beta.4-portable-windows-x64.zip")).Path
$extract = Join-Path $env:TEMP ("Lumina-014b4-Smoke-" + [guid]::NewGuid().ToString("N"))
