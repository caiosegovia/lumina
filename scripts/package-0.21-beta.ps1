...
$release=Join-Path $workspace "src-tauri\target-0.21-beta\release"
$artifacts=Join-Path $workspace "artifacts"
$final=Join-Path $artifacts "Lumina-0.21.0-beta.1-portable-windows-x64"
$zip="$final.zip"
...
foreach($name in @("README.md","SPEC-0.21-BETA.md","ARCHITECTURE-0.21.md","RELEASE-0.21-BETA.md","VALIDATION-0.21-BETA.md","ROADMAP.md")){Copy-Item (Join-Path $workspace $name) $final}
