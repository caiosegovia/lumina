...
$zip = (Resolve-Path (Join-Path $workspace "artifacts\Lumina-0.15.0-beta.1-portable-windows-x64.zip")).Path
$extract = Join-Path $env:TEMP ("Lumina-015b1-Smoke-" + [guid]::NewGuid().ToString("N"))
