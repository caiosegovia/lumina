...
$zip = (Resolve-Path (Join-Path $workspace "artifacts\Lumina-0.9.2-portable-windows-x64.zip")).Path
$extract = Join-Path $env:TEMP ("Lumina-092-Smoke-" + [guid]::NewGuid().ToString("N"))
