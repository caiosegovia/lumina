...
$release=Join-Path $workspace "src-tauri\target-0.16-beta\release"
$artifacts=Join-Path $workspace "artifacts"
$final=Join-Path $artifacts "Lumina-0.16.0-beta.1-portable-windows-x64"
$zip="$final.zip"
...
foreach($name in @("README.md","SPEC-0.16-BETA.md","ARCHITECTURE-0.16.md","DESIGN-0.15-GALLERY.md","RELEASE-0.16-BETA.md","ROADMAP.md")){Copy-Item (Join-Path $workspace $name) $final}
