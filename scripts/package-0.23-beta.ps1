...
$release=Join-Path $workspace "src-tauri\target-0.23.1-beta1\release"
$artifacts=Join-Path $workspace "artifacts"
$final=Join-Path $artifacts "Lumina-0.23.1-beta.1-portable-windows-x64-staging"
$zip=Join-Path $artifacts "Lumina-0.23.1-beta.1-portable-windows-x64.zip"
...
foreach($name in @("README.md","SPEC-0.23.1-FIX.md","RELEASE-0.23.1-FIX.md","VALIDATION-0.23.1-FIX.md","VISUAL-REVIEW-0.23.md","ARCHITECTURE-0.22.2.md","NFR-0.22.2-RESILIENCE.md","ROADMAP.md")){Copy-Item (Join-Path $workspace $name) $final}
