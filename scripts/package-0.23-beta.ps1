...
$release=Join-Path $workspace "src-tauri\target-0.23-beta\release"
$artifacts=Join-Path $workspace "artifacts"
$final=Join-Path $artifacts "Lumina-0.23.0-beta.1-portable-windows-x64"
$zip="$final.zip"
...
foreach($name in @("README.md","SPEC-0.23-BETA.md","RELEASE-0.23-BETA.md","VALIDATION-0.23-BETA.md","ARCHITECTURE-0.22.2.md","NFR-0.22.2-RESILIENCE.md","ROADMAP.md")){Copy-Item (Join-Path $workspace $name) $final}
