...
$zip=(Resolve-Path (Join-Path $workspace "artifacts\Lumina-0.11.0-final-portable-windows-x64.zip")).Path
$extract=Join-Path $env:TEMP ("Lumina-011-Smoke-"+[guid]::NewGuid().ToString("N"))
