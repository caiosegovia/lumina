...
$zip = (Resolve-Path (Join-Path $workspace "artifacts\Lumina-0.23.1-beta.1-portable-windows-x64.zip")).Path
$extract = Join-Path $env:TEMP ("Lumina-0231b1-Smoke-" + [guid]::NewGuid().ToString("N"))
