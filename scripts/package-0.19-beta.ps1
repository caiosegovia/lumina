...
$release=Join-Path $workspace "src-tauri\target-0.19-beta\release"
$artifacts=Join-Path $workspace "artifacts"
$final=Join-Path $artifacts "Lumina-0.19.0-beta.1-portable-windows-x64"
$zip="$final.zip"
...
foreach($name in @("README.md","SPEC-0.19-BETA.md","ARCHITECTURE-0.19.md","RELEASE-0.19-BETA.md","VALIDATION-0.19-BETA.md","ROADMAP.md")){Copy-Item (Join-Path $workspace $name) $final}
