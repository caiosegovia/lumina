...
$release=Join-Path $workspace "src-tauri\target-0.18.3-beta\release"
$artifacts=Join-Path $workspace "artifacts"
$final=Join-Path $artifacts "Lumina-0.18.3-beta.1-portable-windows-x64"
$zip="$final.zip"
...
foreach($name in @("README.md","SPEC-0.18-BETA.md","ARCHITECTURE-0.18.md","RELEASE-0.18-BETA.md","VALIDATION-0.18-BETA.md","HOTFIX-0.18.2-BETA.md","HOTFIX-0.18.3-BETA.md","ROADMAP.md")){Copy-Item (Join-Path $workspace $name) $final}
